        ...
        try {
            while (true) {
                ...
                if (incomingMessage.message.equals("SimplyInsert")) {
                    ...
                    Log.v(AppData.TAG + " Server calling insert ", incomingMessage.key);
                    AppData.myContentResolver.insert(AppData.mUri, value);
                } else if (incomingMessage.message.equals("QueryFromCoordinator")) {

                    String value = null;
                    Log.v(AppData.TAG + " Server calling query ", incomingMessage.key);
                    ...
                    if (c != null) {
                        ...
                        Log.v(AppData.TAG + " Server query response", incomingMessage.key + " : "
                                + value);
                    }
                    c.close();
